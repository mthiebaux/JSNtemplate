...
* The final project template, *Session*, demonstrates a rudimentary account-based, password protected, client-to-client and client-to-group text messaging service.
